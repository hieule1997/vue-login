<template>
  <div class="hello">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-6">
            <p class="mb-0 float-right">
              <span class="mr-3"><a href="tel://#"> <span class="icon-phone mr-2" style="position: relative; top: 2px;"></span><span class="d-none d-lg-inline-block text-black">(+84) 84 365183711</span></a></span>
              <span><a href="#"><span class="icon-envelope mr-2" style="position: relative; top: 2px;"></span><span class="d-none d-lg-inline-block text-black">hieu.leminh@meditech.vn</span></a></span>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="site-blocks-cover overlay aos-init aos-animate" :style="{ backgroundImage: 'url(' + require('@/assets/img/'+backgroundId+'.jpg') + ')' }" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/img/model_1_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/img/model_2_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/img/model_3_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/img/model_4_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/img/model_5_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="../assets/img/product_1_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
    ...
    <div class="site-blocks-cover inner-page-cover overlay get-notification" :style="{ backgroundImage: 'url(' + require('@/assets/img/'+backgroundId+'.jpg') + ')' }"  style="background-attachment: fixed;" data-aos="fade">
      <div class="container">
      ...
      <div class="container">
        <div class="row align-items-lg-center">
          <div class="col-md-8 mb-5 mb-lg-0 position-relative">
            <img src="../assets/img/about_1.jpg" class="img-fluid" alt="Image">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="person text-center">
              <img src="../assets/img/person_2.jpg" alt="Image" class="img-fluid rounded w-75 mb-3">
              <h3>John Rooster</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <div class="person text-center">
              <img src="../assets/img/person_3.jpg" alt="Image" class="img-fluid rounded w-75 mb-3">
              <h3>Tom Sharp</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
            <div class="person text-center">
              <img src="../assets/img/person_4.jpg" alt="Image" class="img-fluid rounded w-75 mb-3">
    ...
    <div class="site-blocks-cover overlay get-notification" id="special-section" :style="{ backgroundImage: 'url(' + require('@/assets/img/'+backgroundId+'.jpg') + ')' }" style="background-attachment: fixed; background-position: top;" data-aos="fade">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <carousel :per-page="1" :autoplay = "true">
              ...
              <div>
                <div class="testimonial">
                  <figure class="mb-4 d-block align-items-center justify-content-center">
                    <div><img src="../assets/img/person_3.jpg" alt="Image" class="w-100 img-fluid mb-3"></div>
                  </figure>
            ...
            <slide>
              <div>
                <div class="testimonial">
                  <figure class="mb-4 d-block align-items-center justify-content-center">
                    <div><img src="../assets/img/person_2.jpg" alt="Image" class="w-100 img-fluid mb-3"></div>
                  </figure>
            ...
            <slide>
              <div>
                <div class="testimonial">
                  <figure class="mb-4 d-block align-items-center justify-content-center">
                    <div><img src="../assets/img/person_4.jpg" alt="Image" class="w-100 img-fluid mb-3"></div>
                  </figure>
                  <blockquote class="mb-3">
                    <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
                  </blockquote>
            ...
            <slide>
              <div>
                <div class="testimonial">
                  <figure class="mb-4 d-block align-items-center justify-content-center">
                    <div><img src="../assets/img/person_1.jpg" alt="Image" class="w-100 img-fluid mb-3"></div>
                  </figure>
                  <blockquote class="mb-3">
                    <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
                  </blockquote>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3 ml-auto">
            ...
            <a href="#"><img src="../assets/img/product_1_bg.jpg" alt="Image" class="img-fluid mb-3"></a>
...
<style src="../assets/fonts/flaticon/font/flaticon.css" rel="stylesheet"></style>
<style src="../assets/fonts/icomoon/style.css" rel="stylesheet"></style>
<style src="../assets/css/bootstrap.min.css" rel="stylesheet"></style>
<style src="../assets/css/style.css" rel="stylesheet"></style>
<script>
import AOS from 'aos'
